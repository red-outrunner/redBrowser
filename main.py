...
# Import QWebEnginePage to correctly handle browser profiles
from PyQt5.QtWebEngineWidgets import (
    QWebEngineView, QWebEngineProfile, QWebEngineDownloadItem, QWebEngineSettings, QWebEnginePage
)
...
class WebBrowser(QMainWindow):
    def __init__(self):
        ...
        # Set a modern user agent on the default profile
    ...
    def add_new_tab(self, url="https://www.duckduckgo.com", html_content=None, title="New Tab"):
        """Adds a new tab to the browser, either with a URL or with custom HTML content."""
        tab = QWidget()
        layout = QVBoxLayout()
        web_view = QWebEngineView()
        
        # --- FIX FOR PROFILE ATTRIBUTE ERROR ---
        # Create a new page with the custom profile and set it on the view
        page = QWebEnginePage(self.profile, web_view)
        web_view.setPage(page)
        # ----------------------------------------

        # --- JAVASCRIPT AND MODERN WEB FEATURES SETTINGS ---
